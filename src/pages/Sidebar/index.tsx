const Sidebar = () => {
  const onDragStart = (event: any, nodeType: any) => {
    ...
    event.dataTransfer.setData("dataNode", JSON.stringify({ name: "auto" }));
    ...
    <div className="flex flex-col gap-2 items-center p-4">
      <div className=" overflow-y-auto bg-white flex flex-col gap-2 w-full">
        <div
          ...
          onDragStart={(event) => onDragStart(event, "conditionals")}
          draggable
        >
          <svg
        ...
        <div
          className="menu-item dndnode"
          onDragStart={(event) => onDragStart(event, "departments")}
          draggable
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
